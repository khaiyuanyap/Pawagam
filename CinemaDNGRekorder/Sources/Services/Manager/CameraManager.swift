...
class CameraManager: NSObject, ObservableObject {
    ...
    let deviceConfigurationQueue = DispatchQueue(label: "com.cinemadngrekorder.device.configuration")
    ...
    let audioProcessingQueue = DispatchQueue(label: "com.cinemadngrekorder.audioprocessing")
